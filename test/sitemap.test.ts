...
describe('SitemapParser', () => {
  it('should parse URL set', () => {
    ...
    const entries = (parser as any).parseUrlSet(mockSitemapXML)
  ...
  it('should parse URL block with all fields', () => {
    ...
    const entry = (parser as any).parseUrlBlock(urlBlock)
  ...
  it('should extract sitemap URLs from index', () => {
    ...
    const urls = (parser as any).extractSitemapUrls(mockSitemapIndexXML)
  ...
  it('should apply include patterns filter', () => {
    ...
    const filtered = (parser as any).applyFilters(entries)
...
describe('Sitemap Entry Types', () => {
  it('should handle all changefreq values', () => {
    ...
    frequencies.forEach((freq) => {
      ...
      const entry = (parser as any).parseUrlBlock(urlBlock)
      expect(entry?.changefreq).toBe(freq as SitemapEntry['changefreq'])
    })
  })
